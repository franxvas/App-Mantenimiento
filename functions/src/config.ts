...
export const graphParametrosFolder = defineString("GRAPH_PARAMETROS_FOLDER");
...
const DEFAULT_PARAMETROS_FOLDER = "/Apps/InteriorMaintenance/Parametros";
...
export const getGraphConfig = () => {
  ...
  const parametrosFolder = graphParametrosFolder.value() || DEFAULT_PARAMETROS_FOLDER;
